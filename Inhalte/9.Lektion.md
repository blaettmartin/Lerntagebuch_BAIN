...
_- Qf = queryfield für das Ranking_
_- Highlighting Felder --> Die Query die bei einem einfachen Suchfeld an den Solar sendet_
_- Json.nl = arrar -->wie Json zurück gegeben werden soll_

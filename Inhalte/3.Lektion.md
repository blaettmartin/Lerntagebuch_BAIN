...
-	Reconcile (von Reconciliation == Versöhnung) ist wenn man den Datensatz mit einer Datenquelle, zb Wikidata abgleicht und daraus ergänzt. Dies wird in einer weiteren Lektion genauer behandelt.
...
Ich fand die Lektion interessant, da ich die Anwendung Open Refine noch nicht kannte. Beim durchklicken und anwenden in der Lektion empfand ich die Anwendung als verständlich und intuitiv, denke mir aber je mehr man diese verwendet desto einfacher geht es dann. Bei einer grossen Ablieferungsliste könnte es bei mir im Stadtarchiv Zürich durchaus interessant sein, diese Anwendung zu verwenden.
